...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full rounded-xl font-sans md:px-10" ref={containerRef}>
      <h1 className="max-w-4xl text-2xl lg:text-3xl">UX/UI</h1>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              ...
              <div className="hidden flex-col md:flex md:pl-20 md:text-3xl">
                <h3> {item.title}</h3>
            ...
            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <h3 className="mb-4 block text-left text-2xl md:hidden">
                {item.title}
              </h3>
              {item.content}{' '}
            </div>
